...
std::vector<ompl::base::State*> Ompl::getPathStates(const ompl::base::PathPtr&)
{
...
#else
    std::shared_ptr<ompl::geometric::PathGeometric> pathGeometric = std::dynamic_pointer_cast<ompl::geometric::PathGeometric>(mpPathInGridOmpl);
    if(!pathGeometric)
    {
